...
%==> enkel het laatste model en de andere lineaire modellen (simpelmodellen) worden besproken, ik heb deze tabel gemaakt voor de duidelijkheid en heb geen zin deze te verwijderen, anders moet een hele alinea herschreven worden.
	...
	\section*{Besluit}
	We concluderen dat prijzen voor airbnb's in Amsterdam niet veel beïnvloed worden door de gemeten waarden. Het regressie model dat opgesteld werd kon namelijk, uit de bijgestelde $R^2$-waarde, maar 20\% van de verandering in prijs voorspellen.
	Uit de meetwaarden merken we dat de tevredenheidsscore en de afstand tot het stadscentrum een sterke invloed hebben op de prijs . De attractiescore heeft ook een invloed, maar met afnemende meeropbrengsten.
