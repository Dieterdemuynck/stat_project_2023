...
\begin{table}[h]
	...
	\label{uitreksel}
	% TODO: Append tables for capacity and bedrooms
\end{table}
	...
	Daarna wordt er via achterwaartse regressie een meervoudig regressiemodel gezocht, waar we alle continue variabelen voor gebruiken en ook gebruik maken van  $log_{10}$-transformaties. Ten slotte wordt nog bestudeerd of de binaire variabele \verb|dummy|, \verb|room| == volledige woning, een significante invloed heeft op het model. Voor alle modellen wordt de kwaliteit ook onderzocht. Dit doen we aan de hand van ingebouwde functies in R. % TODO: replace "dummy" and "room" with natural language
